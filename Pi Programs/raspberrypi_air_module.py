...
#Allow start from any directory
...
if __name__ == "__main__":
    ...
    dataCSV = "data/flightdata " + filetime + ".csv" #Set up CSV name for datalogging
    ...
    with open(dataCSV, 'w') as dataCSV:
        ...
        while (flightComplete == 0):
            ...
            dataRow = [ltime, cax, cay, caz, cgx, cgy, cgz, cmx, cmy, cmz, pressure, asl, agl,' ', temp ]
